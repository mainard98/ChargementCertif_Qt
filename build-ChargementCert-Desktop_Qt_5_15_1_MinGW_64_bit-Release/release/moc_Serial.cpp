...
#include <memory>
#include "../../ChargementCert/Serial.h"
...
QT_MOC_LITERAL(1, 7, 9), // "dataTrame"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 10) // "serialRead"

    },
    "Serial\0dataTrame\0\0serialRead"
};
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataTrame((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::dataTrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Serial::dataTrame(QByteArray _t1)
{
